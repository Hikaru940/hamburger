<?php get_header(); ?>
    <?php get_sidebar(); ?>
        ...
        <figure class="p-top-image">
            <img src="<?php bloginfo('template_url'); ?>/img/3ba5a44414bb3c0885c27ff614596431.png" alt="" class="p-top-image__img">
            <h2 class="p-top-image__head p-top-image--size">ダミーサイト</h2>
        </figure>
        <div class="p-container-card">
            <article class="p-card-out">
                <img src="<?php bloginfo('template_url'); ?>/img/three-burgers-on-brown-wooden-tray-between-white-ceramic-6@2x.png" alt="Take Out Image" class="p-card-out__img">
            ...
            <article class="p-card-in">
                <img src="<?php bloginfo('template_url'); ?>/img/473d814b175bd517b56eb309f2958725.png" alt="" class="p-card-in__img">
        ...
        <div class="p-map">
            <img src="<?php bloginfo('template_url'); ?>/img/スクリーンショット 2020-02-10 11.47.42.png" alt="" class="p-map__img">
